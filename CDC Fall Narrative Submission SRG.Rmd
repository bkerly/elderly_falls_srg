...
>>>>>>> dbb1c7eb40e6ad0be6feecb586f45fcc43c42778
## Introduction
...
```{r injury patterns, include = TRUE, warning=FALSE,message=FALSE}
...
ggplot(data = injury_patterns) +
  ...
  ylab("")+
  xlab("") + 
  labs(title = "Association of Injury Patterns with Frailty")
...
```{r Saturation Plots, fig.dim = c(4,3), warning=FALSE,message=FALSE}
